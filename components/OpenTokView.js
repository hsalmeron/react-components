			...
			<View style={[styles.container, styles.streamWindow]}>
				...
				<View style={styles.overlayBar}>
					<TouchableOpacity onPress={stopStreaming}>
						<Image style={styles.icon} source={require('../images/pause.png')} />
					</TouchableOpacity>
					<TouchableOpacity onPress={() => toggleFullscreen(true)}>
						<Image style={styles.icon} source={require('../images/fullscreen.png')} />
					</TouchableOpacity>
				</View>
				...
				>
					...
					<View style={styles.overlayBar}>
						...
						<TouchableOpacity onPress={() => toggleFullscreen(false)}>
							<Image
								style={styles.icon}
								source={require('../images/fullscreen_shrink.png')}
							/>
						</TouchableOpacity>
					</View>
				</Modal>
